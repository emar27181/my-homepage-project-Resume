...
export const translations = {
  ja: {
    ...
    // 個人情報
    profileDescription: '明治大学大学院理工学研究科情報科学専攻を2026年3月に修了し、現在は通信業界でITエンジニアとして勤務中。過去に書いたコードはGitHubにて公開しています。スポーツやイラスト、ゲームなど、趣味として幅広く楽しんでいます。イラスト作品は',
    galleryLinkText: 'こちら',
    galleryLinkSuffix: 'からご覧いただけます。',
    
    // プロジェクト
    galleryPortfolio: 'ギャラリーポートフォリオ',
    galleryPortfolioDesc: '制作したイラストや動画などをグリッド上に展示しています．',
    colorRecommendApp: '色相・トーン推薦アプリ',
    colorRecommendAppDesc: '研究内容のイラスト制作における色の推薦のデモを公開しています．',
    ...
    gamePortfolioDesc: 'ゲームアカウントに関する情報やプレイ実績をまとめたポートフォリオサイトです。',
  ...
  en: {
    ...
    colorRecommendAppDesc: 'A demo of my research on color recommendation for illustration.',
